 ...
 * @link     https://github.com/boba/slim-api-seed Slim API Seed
 */
class HelloNameTest extends \PHPUnit\Framework\TestCase
{
    const TEST_SETTINGS = [
        'defaults' => [
     ...
     * @return void
     */
    public function testHelloNameGetHTMLFormat()
    {
     ...
     * @return void
     */
    public function testHelloNameGetJsonFormat()
    {
        /**
         * Response object
         *
     ...
     * @return void
     */
    public function testHelloNameGetDefault()
    {
        $env = Environment::mock(
            [
                'REQUEST_METHOD' => 'GET',
